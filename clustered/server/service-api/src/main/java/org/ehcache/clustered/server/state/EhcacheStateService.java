...
public interface EhcacheStateService {
  ...
  ServerSideServerStore createStore(String name, ServerStoreConfiguration serverStoreConfiguration, boolean forActive, Function<Chain,Boolean> pinningCheck) throws ConfigurationException;
  ...
  void loadExisting(ServerSideConfiguration config);
