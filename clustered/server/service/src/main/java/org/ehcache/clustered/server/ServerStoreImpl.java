...
public class ServerStoreImpl implements ServerSideServerStore {
  ...
  public ServerStoreImpl(ServerStoreConfiguration storeConfiguration, ResourcePageSource pageSource, KeySegmentMapper mapper, boolean writeBehindConfigured, Function<Chain,Boolean> pinningCheck) {
    this.storeConfiguration = storeConfiguration;
    this.pageSource = pageSource;
    this.store = new OffHeapServerStore(pageSource, mapper, writeBehindConfigured, pinningCheck);
  }
